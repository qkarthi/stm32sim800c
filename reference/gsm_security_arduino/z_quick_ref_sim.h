AT //BASIC AT COMMAND
ATH //CALL HANG COMMAND

AT+CLIP=1


//TOTAL MESSAGE COMMENT
{
  AT+CMGF=1
  AT+CMGS="8870767575"
  Serial.println(msg);
...
ATD9524770257 //CALL COMMAND

gsm_serial.println("AT+CMGS=\"8870767575\"");

AT+CMEE=1 //DEBUG DISABLE
AT+CMEE=2 //DEBUG ENABLE

AT+CREG? //AVAILABLE NWTWORK
(WAIT FOR 30 SEC + )
